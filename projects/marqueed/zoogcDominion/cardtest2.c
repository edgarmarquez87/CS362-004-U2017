...
int main(int argc, char** argv)
{
	...
	//test = adventurerFunction(&testGame);
	test = cardEffect(adventurer, 0, 0, 0, &testGame, 0, 0);
	...
	printf("\nTest for silver to end loop and return not NULL\n");
	...
	printf("\nTest for gold to end loop and return not NULL\n");
